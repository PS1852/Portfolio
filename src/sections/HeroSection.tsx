...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="section-padding relative w-full pt-32 pb-20" style={{ zIndex: 3 }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div ref={taglineRef} style={{ opacity: 0 }} className="mb-8">
            ...
            >
              That{' '}
              <span className="text-emerald-600 font-medium">captivate</span>
              {' '}and{' '}
              <span className="text-emerald-600 font-medium">convert</span>
            </p>
          </div>
      ...
      >
        <span className="text-xs tracking-[0.2em] uppercase text-muted font-mono">Scroll</span>
        <div className="w-px h-12 bg-gradient-to-b from-emerald-500 to-transparent scroll-indicator-dot" />
      </div>

      {/* Stats strip */}
      <div
        className="absolute bottom-0 right-0 hidden lg:flex items-center gap-10 section-padding py-6"
        style={{ zIndex: 3, borderTop: '1px solid rgba(209, 231, 221, 0.4)' }}
      >
        <div className="text-right">
          <div className="text-2xl font-bold text-ink font-display">100+</div>
          <div className="text-xs text-muted font-mono tracking-wider">Projects</div>
        </div>
        <div className="w-px h-8 bg-border-green" />
        <div className="text-right">
          <div className="text-2xl font-bold text-ink font-display">5+</div>
          <div className="text-xs text-muted font-mono tracking-wider">Years</div>
        </div>
        <div className="w-px h-8 bg-border-green" />
        <div className="text-right">
          <div className="text-2xl font-bold text-ink font-display">99%</div>
          <div className="text-xs text-muted font-mono tracking-wider">Satisfaction</div>
        </div>
      </div>
    </section>
  )
