...
import { LogoGemPrimitive } from '@/components/shared/Logo3D'

function InteractiveEmerald() {
  return (
    <div className="absolute top-10 -right-10 lg:-right-24 w-[400px] h-[400px] lg:w-[800px] lg:h-[800px] z-20 hidden md:block cursor-grab active:cursor-grabbing pointer-events-auto">
